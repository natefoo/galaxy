...
class TapisOAuth2(BaseOAuth2):
    ...
    def get_user_id(self, details, response):
        ...
        log.debug(f"get_user_id: Generated unique ID '{user_id}' for username '{username}' on tenant '{tenant}'")
        return user_id
    ...
    def get_user_details(self, response):
        ...
        log.debug(f"get_user_details: Extracted user details: {user_details}")
        return user_details
